...
TOP_K_RESULTS = 20
TOP_N_RERANK = 5
EVALUATION_PATH = "evaluation_value.json"
...
class ChatService:
    ...
    def generate_response(self, query: str) -> None:
        ...
        system_instructions = """
            Você é uma assistente jurídica especializada em documentos jurídicos com artigos da lei.
                ...
                - Evite responder conteúdo de temas sensíveis que não condigam com o contexto.
    ...
    def generate_response_from_context(
        ...
        """
        Gera resposta usando chunks já recuperados,
        sem refazer retrieval nem reranking.
        """
    ...
    Sua função é orientar o usuário com base na legislação,
    explicando de forma clara, objetiva e acessível.

    Regras importantes:
    - Responda SOMENTE com base no contexto fornecido.
    - Não invente informações.
    - Se a resposta não estiver no contexto diga:
    "Não encontrei essa informação nos documentos armazenados."
    - Sempre que possível cite o artigo da lei.
    """
